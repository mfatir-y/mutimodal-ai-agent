...
#     print(str.upper("Description: "), cleaned_json['description'])
#     print(str.upper("Filename: "), cleaned_json['filename'])
#
#     try:
...
#         print(f'Code successfully written in: {cleaned_json["filename"]}')
#     except Exception as e:
#         print(f'There was an error writing to file: {e}')
